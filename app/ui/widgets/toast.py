...
Floating Apple HIG toast status banner with auto-dismiss and smooth fade animations.
"""
...
class Toast(QWidget):
    """
    Floating capsule toast notification banner conforming to Apple HIG.
    """
    ...
    def show_message(self, message: str, toast_type: str = "info", duration_ms: int = 2500):
        ...
        self.icon_label.setStyleSheet(f"color: {colors.get(toast_type, '#0A84FF')}; font-weight: bold; font-size: 15px; background: transparent;")
